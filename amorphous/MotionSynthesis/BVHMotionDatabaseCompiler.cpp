...
static void AlignLastKeyframeBVH( std::vector<Keyframe>& vecKeyframe )
{
...
void BVHMotionDatabaseCompiler::CreateMotionPrimitives( MotionPrimitiveDescGroup& desc_group )
{
	BVHPlayer bvh_player;
