...
struct VS_OUTPUT
{
    ...
    float3 LightVS	:	TEXCOORD1;

//	float4 DirToCamera : TEXCOORD2;	// store direction to the camera for each vertex
};
...
VS_OUTPUT VS_Main ( VS_INPUT In )
{
   ...
   float3 P = mul( In.vPosition, WorldView );           //position in view space
...
technique MultiPassShader
{
    ...
    {
        // static geometry
        VertexShader = NULL;	//compile vs_2_0 VS_StaticGeometry();
        PixelShader  = NULL;	//compile ps_2_0 PS_StaticGeometry();
    }
