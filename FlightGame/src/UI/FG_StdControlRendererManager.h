#ifndef  __FG_STDCONTROLRENDERERMANAGER_H__
#define  __FG_STDCONTROLRENDERERMANAGER_H__


#include "UI/GM_ControlRendererManager.h"


class CFG_StdControlRendererManager : public CGM_ControlRendererManager
{
public:

	CFG_StdControlRendererManager();
	virtual ~CFG_StdControlRendererManager() {}
...
#endif		/*  __FG_STDCONTROLRENDERERMANAGER_H__  */
