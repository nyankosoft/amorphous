...
public:
	CTextureLoader( const char* szFileName, CPackedFile* pPackedFile );
	~CTextureLoader();
...
//	ID3D10ShaderResourceView*   m_pRealRV10;
	...
	IDirect3DTexture9*			m_pStagingTexture9;
...
public:
//	CTextureProcessor( ID3D10Device* pDevice, ID3D10ShaderResourceView** ppRV10, CResourceReuseCache* pResourceReuseCache );
	CTextureProcessor( IDirect3DDevice9* pDevice, IDirect3DTexture9** ppTexture9, CResourceReuseCache* pResourceReuseCache );
	~CTextureProcessor();
