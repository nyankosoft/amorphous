...
static_geometry = misc_util.CreateStaticGeometry( resource_path = "Stage/hills.sga" )

stage.SetTextureShaderParamToEntity( entity=static_geometry, param_name="stage:2", tex_path="textures/common_ground.jpg" )
