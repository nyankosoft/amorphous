...
//	else
//	{
//		loaded = m_EnvMappedMeshShader.Load( "./shaders/CubeMapTest.fx" );
//	}
...
void CCubeMapTest::Update( float dt )
{
}


void CCubeMapTest::Render()
{
...
//void CCubeMapTest::HandleInput( const InputData& input )
//{
...
void CCubeMapTest::UpdateViewTransform( const Matrix44& matView )
{
//	m_pCubeMapManager->UpdateViewTransform( matView );
}


void CCubeMapTest::UpdateProjectionTransform( const Matrix44& matProj )
{
