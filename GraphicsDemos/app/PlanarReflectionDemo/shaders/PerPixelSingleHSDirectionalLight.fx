...
void VS_PerPixelSingleHSDirectionalLIght(
	float3 Pos     : POSITION, 
...
float4 PS_PerPixelSingleHSDirectionalLIght(
       float4 Diffuse  : COLOR0,
       float2 Tex0     : TEXCOORD0,
...
technique Default
{
	pass P0
	{
		VertexShader = compile vs_1_1 VS_PerPixelSingleHSDirectionalLIght();
		PixelShader  = compile ps_2_0 PS_PerPixelSingleHSDirectionalLIght();
//		CullMode = Ccw;
	}
}
