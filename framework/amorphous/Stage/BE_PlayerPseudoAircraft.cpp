...
#include "amorphous/GameTextSystem/TextMessageManager.hpp"
...
//	m_Camera.SetFOV( (float)PI / 8.0f );
	...
	m_Camera.SetAspectRatio( GraphicsComponent::GetAspectRatio() );
...
//		GetSoundManager().PlayAt( m_aDamageSound[rGameMessage.s1][iVariation], pCopyEnt_Self->Position() );
