...
*/
inline void LoadFromXMLNode( const XMLNode& reader, Vector3& dest )
{
	std::string pos_str;
	dest = Vector3(0,0,0);
...
inline void LoadFromXMLNode( const XMLNode& reader, Matrix33& dest )
{
...
inline void LoadFromXMLNode( const XMLNode& reader, Matrix34& dest )
{
