...
protected:
	...
	std::shared_ptr<GraphicsElement> m_pTargetElement;
...
public:
	...
	GraphicsElementAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
...
//	std::shared_ptr<GraphicsElement> GetElement() { m_pManager->GetGraphicsElementManager()->GetElement(m_TargetElementID); }
	std::shared_ptr<GraphicsElement> GetElement();
...
public:
	...
	GraphicsElementLinearAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
...
public:
	...
	GraphicsElementNonLinearAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
...
public:
	...
	ColorShiftAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
...
public:
	...
	AlphaShiftAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
		: GraphicsElementLinearAnimation( pTargetElement, start_time, end_time ),
...
public:
	...
	TranslationAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
		: GraphicsElementLinearAnimation( pTargetElement, start_time, end_time ) {}
...
public:
	...
	SizeChangeAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
		: GraphicsElementLinearAnimation( pTargetElement, start_time, end_time ) {}
...
public:
	...
	RotationAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
		: GraphicsElementLinearAnimation( pTargetElement, start_time, end_time ) {}
...
class CE_TextDraw : public GraphicsElementLinearAnimation
{
	...
	std::shared_ptr<TextElement> m_pTextElement;

public:

	CE_TextDraw( std::shared_ptr<TextElement> pTargetElement, double start_time );
...
public:
	...
	ScalingAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
...
class CE_NonLinearVertexColorShift : public GraphicsElementNonLinearAnimation
{
	...
	std::shared_ptr<PolygonElement> m_pPolygonElement;

public:

	CE_NonLinearVertexColorShift( std::shared_ptr<PolygonElement> pTargetElement, double start_time )
...
public:
	...
	NonLinearTranslationAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
...
public:
	...
	SizeChangeAnimationCD( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
		: GraphicsElementNonLinearAnimation( pTargetElement, start_time, end_time ) {}
...
public:
	...
	NonLinearScalingAnimation( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time )
...
public:
	...
	CE_Blink( std::shared_ptr<GraphicsElement> pTargetElement ) : GraphicsElementNonLinearAnimation(pTargetElement, 0.0f, 10000.0f ), m_fAccumulatedTime(0) {}
	~CE_Blink() {}
...
public:
	...
	CE_AlphaBlink( std::shared_ptr<GraphicsElement> pTargetElement )
		:
...
public:
	...
	CE_SineWave( std::shared_ptr<GraphicsElement> pTargetElement )
		:
...
public:
	...
	CE_SineWaveAlphaChange( std::shared_ptr<GraphicsElement> pTargetElement )
		:
...
public:
	...
	CE_SineWaveColorChange( std::shared_ptr<GraphicsElement> pTargetElement )
		:
	CE_SineWave( pTargetElement ) 
	{
...
public:
	...
	virtual std::shared_ptr<GraphicsElementManager> GetGraphicsElementManager() { return std::shared_ptr<GraphicsElementManager>(); }
	virtual void SetTimeOffset( double time = -1.0 ) {}

	virtual GraphicsElementAnimationHandle ChangeAlpha( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, int color_index, float start_alpha, float end_alpha, int trans_mode ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ChangeAlphaTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, int color_index, float end_alpha, int trans_mode ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ChangeColor( std::shared_ptr<GraphicsElement> pTargetElement, double start_time,  double end_time, int color_index, const SFloatRGBAColor& start_color, const SFloatRGBAColor& end_color, int trans_mode ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ChangeColor( std::shared_ptr<GraphicsElement> pTargetElement, double start_time,  double end_time, int color_index, const SFloatRGBColor& start_color, const SFloatRGBColor& end_color, int trans_mode ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ChangeColorTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, int color_index, const SFloatRGBAColor& end_color, int trans_mode ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ChangeColorTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, int color_index, const SFloatRGBColor& end_color, int trans_mode ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ChangeColorTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, int color_index, U32 end_color, int trans_mode ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ChangeSize( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, Vector2 vDestMin, Vector2 vDestMax ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ScaleTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, float end_scale ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle TranslateTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, Vector2 vDestPos, int coord_type, int trans_mode ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle TranslateNonLinear( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, Vector2 vDestPos, Vector2 vInitVel = Vector2(0,0), float smooth_time = 0.5f, int coord_type = 0, U32 flags = 0 ) { return GraphicsElementAnimationHandle::Null(); }

	virtual GraphicsElementAnimationHandle BlinkAlpha( std::shared_ptr<GraphicsElement> pTargetElement, double interval, int color_index = 0 ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle BlinkAlpha( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, double interval, float alpha ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle BlinkAlpha( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, double duration0, double duration1, float alpha0, float alpha1 ) { return GraphicsElementAnimationHandle::Null(); } 

	virtual GraphicsElementAnimationHandle ChangeAlphaInSineWave( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double period, int color_index, float alpha0, float alpha1, int num_periods = -1 ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ChangeColorInSineWave( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double period, int color_index, const SFloatRGBAColor& color0, const SFloatRGBAColor& color1, int num_periods = -1 ) { return GraphicsElementAnimationHandle::Null(); }

	virtual GraphicsElementAnimationHandle DrawText( std::shared_ptr<TextElement> pTargetTextElement, double start_time, int num_chars_per_sec ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle ChangeVertexColorNonLinear( std::shared_ptr<PolygonElement> pTargetTextElement, double start_time,
	...
	virtual GraphicsElementAnimationHandle SetPosition( std::shared_ptr<GraphicsElement> pTargetElement, double time, const Vector2& vPos ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle SetColor( std::shared_ptr<GraphicsElement> pTargetElement, double time, int color_index, const SFloatRGBAColor& color ) { return GraphicsElementAnimationHandle::Null(); }
	virtual GraphicsElementAnimationHandle SetColor( std::shared_ptr<GraphicsElement> pTargetElement, double time, int color_index, const U32& color ) { return GraphicsElementAnimationHandle::Null(); }
...
//	GraphicsElementAnimationManager( GraphicsElementManager *pElementManager );
	...
	std::shared_ptr<GraphicsElementManager> GetGraphicsElementManager() { return m_pGraphicsElementManager; }

	std::shared_ptr<GraphicsElement> GetElement( int element_id ) { return m_pGraphicsElementManager->GetElement(element_id); }
...
//	void AddFadeOutEffect( int id, float start, float end, float dest_alpha );
	...
	GraphicsElementAnimationHandle ChangeAlpha( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, int color_index, float start_alpha, float end_alpha, int trans_mode );
	GraphicsElementAnimationHandle ChangeAlphaTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, int color_index, float end_alpha, int trans_mode );

	GraphicsElementAnimationHandle ChangeColor( std::shared_ptr<GraphicsElement> pTargetElement, double start_time,  double end_time,
	...
	GraphicsElementAnimationHandle ChangeColorTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time,
	...
	GraphicsElementAnimationHandle ChangeSize( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, Vector2 vDestMin, Vector2 vDestMax );

	GraphicsElementAnimationHandle ScaleTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, float end_scale );

	/// move an element from its current position to a new destination
	GraphicsElementAnimationHandle TranslateTo( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, Vector2 vDestPos, int coord_type, int trans_mode );
	...
	GraphicsElementAnimationHandle TranslateNonLinear( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, Vector2 vDestPos, Vector2 vInitVel, float smooth_time, int coord_type, U32 flags );
	...
	GraphicsElementAnimationHandle BlinkAlpha( std::shared_ptr<GraphicsElement> pTargetElement, double interval, int color_index );

//	GraphicsElementAnimationHandle BlinkAlpha( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, double interval, float alpha ); 
//	GraphicsElementAnimationHandle BlinkAlpha( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double end_time, double duration0, double duration1, float alpha0, float alpha1 ); 

	GraphicsElementAnimationHandle ChangeAlphaInSineWave( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double period, int color_index, float alpha0, float alpha1, int num_periods );

	GraphicsElementAnimationHandle ChangeColorInSineWave( std::shared_ptr<GraphicsElement> pTargetElement, double start_time, double period, int color_index, const SFloatRGBAColor& color0, const SFloatRGBAColor& color1, int num_periods );
	...
	GraphicsElementAnimationHandle DrawText( std::shared_ptr<TextElement> pTargetTextElement, double start_time, int num_chars_per_sec );

	GraphicsElementAnimationHandle ChangeVertexColorNonLinear( std::shared_ptr<PolygonElement> pTargetTextElement, double start_time,
		int color_index, int vertex,
...
//	void SetElementPath_End();
	...
	GraphicsElementAnimationHandle SetPosition( std::shared_ptr<GraphicsElement> pTargetElement, double time, const Vector2& vPos );
	GraphicsElementAnimationHandle SetColor( std::shared_ptr<GraphicsElement> pTargetElement, double time, int color_index, const SFloatRGBAColor& color );
	virtual inline GraphicsElementAnimationHandle SetColor( std::shared_ptr<GraphicsElement> pTargetElement, double time, int color_index, const U32& color );
...
inline GraphicsElementAnimationHandle GraphicsElementAnimationManager::SetColor( std::shared_ptr<GraphicsElement> pTargetElement, double time, int color_index, const U32& color )
{
