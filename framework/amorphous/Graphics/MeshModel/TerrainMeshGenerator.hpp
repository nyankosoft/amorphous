...
//	std::vector<C3DMeshModelArchive> m_vecMeshArchive;
	...
	std::shared_ptr<General3DMesh> m_pSrcMesh;

	std::shared_ptr<General3DMesh> m_pDestMesh;
...
public:
	...
	bool Build( std::shared_ptr<General3DMesh> pSrcMesh, int target_depth );
	...
	std::shared_ptr<General3DMesh> GetDestMesh() { return m_pDestMesh; }
...
public:
	...
	bool BuildTerrainMesh( std::shared_ptr<General3DMesh> pSrcMesh );
...
//	void GetMeshArchive( std::vector<C3DMeshModelArchive>& dest_mesh ) { dest_mesh = m_MeshTree.GetMeshArchive(); }
	...
	std::shared_ptr<General3DMesh> GetDestMesh() { return m_MeshTree.GetDestMesh(); }
