...
AsyncLoadingDemo::AsyncLoadingDemo()
:
...
void AsyncLoadingDemo::CreateSampleUI()
{
}


bool AsyncLoadingDemo::InitShader()
{
	// initialize shader
	bool shader_loaded = m_Shader.Load( "AsyncLoadingDemo/shaders/AsyncLoadingDemo.fx" );
...
void AsyncLoadingDemo::CreateCachedResources()
{
...
//void AsyncLoadingDemo::LoadTexturesAsync()
void AsyncLoadingDemo::LoadResourcesAsync( CTestMeshHolder& holder )
{
...
void AsyncLoadingDemo::RenderMeshes()
{
...
void AsyncLoadingDemo::SaveTexturesAsImageFiles()
{
...
void AsyncLoadingDemo::ReleaseGraphicsResources()
{
//	m_pSampleUI.reset();
}


void AsyncLoadingDemo::LoadGraphicsResources( const GraphicsParameters& rParam )
{
//	CreateSampleUI();
}
