...
void BrickWallTextureGeneratorDemo::SetLights( bool use_hemespheric_light )
{
...
bool BrickWallTextureGeneratorDemo::InitShader()
{
...
int BrickWallTextureGeneratorDemo::Init()
{
	bool loaded = false;
...
int BrickWallTextureGeneratorDemo::LoadMesh()
{
	MeshResourceDesc mesh_desc;
...
void BrickWallTextureGeneratorDemo::Update( float dt )
{
}


void BrickWallTextureGeneratorDemo::RenderMeshes()
{
...
void BrickWallTextureGeneratorDemo::Render()
{
	PROFILE_FUNCTION();
...
void BrickWallTextureGeneratorDemo::HandleInput( const InputData& input )
{
