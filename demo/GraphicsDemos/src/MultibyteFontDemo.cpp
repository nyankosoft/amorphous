...
MultibyteFontDemo::MultibyteFontDemo()
:
m_FontIndex(0),
m_FontSize(32)
{
...
bool MultibyteFontDemo::RenderUTF8TextToBufferToImageFile( const std::string& text,
...
void MultibyteFontDemo::CreateSampleUI()
{
}
...
int MultibyteFontDemo::InitFont()
{
...
void MultibyteFontDemo::Update( float dt )
{
//	if( m_pSampleUI )
...
void MultibyteFontDemo::HandleInput( const InputData& input )
{
