...
{
	return new CPrecipitationEffectTest();
}


CPrecipitationEffectTest::CPrecipitationEffectTest()
{
...
void CPrecipitationEffectTest::CreateSampleUI()
{
}


bool CPrecipitationEffectTest::InitShader()
{
	// initialize shader
...
int CPrecipitationEffectTest::Init()
{
...
void CPrecipitationEffectTest::Update( float dt )
{
...
void CPrecipitationEffectTest::RenderMeshes()
{
...
void CPrecipitationEffectTest::Render()
{
	PROFILE_FUNCTION();
...
void CPrecipitationEffectTest::HandleInput( const InputData& input )
{
