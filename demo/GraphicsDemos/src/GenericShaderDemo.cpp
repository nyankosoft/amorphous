...
void GenericShaderDemo::CreateSampleUI()
{
}


bool GenericShaderDemo::SetShaderParams( ShaderManager& shader_mgr )
{
...
bool GenericShaderDemo::InitShader()
{
...
void GenericShaderDemo::Update( float dt )
{
//	if( m_pSampleUI )
...
void GenericShaderDemo::RenderMeshes()
{
...
void GenericShaderDemo::RenderDebugInfo()
{
}


void GenericShaderDemo::RenderShaderInfo()
{
...
void GenericShaderDemo::HandleInput( const InputData& input )
{
